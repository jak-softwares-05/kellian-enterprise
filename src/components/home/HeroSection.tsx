                ...
                <div className="px-10 py-5 lg:py-64 lg:px-32 z-10 text-white lg:w-2/3 space-y-5">
                    <div className='space-y-5'>
                        ...
                        <p className='text-xl lg:text-2xl'>
                            We bring years of experience and a commitment to quality that ensures your vehicle stays in
                            top condition, you can trust us to get your car back on the road quickly and efficiently.
                        </p>
                    </div>
